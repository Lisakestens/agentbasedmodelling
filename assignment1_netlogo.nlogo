...
airplanes-1-own []
airplanes-2-own [nearest-airplane direction]
...
to find-nearest-airplane
   set nearest-airplane min-one-of airplanes-in-vision [distance myself]
end
...
to-report deviation-angle
  ifelse abs minimum-separation / length-until-intersection > 1
